 ...
 * @LastEditTime: 2023-07-16 22:20:14
 * @FilePath: /bustub-20221128-2022fall/src/storage/page/b_plus_tree_leaf_page.cpp
...
INDEX_TEMPLATE_ARGUMENTS
void B_PLUS_TREE_LEAF_PAGE_TYPE::MoveAllTo(BPlusTreeLeafPage *recipent) {
  recipent->CopyNFrom(array_, GetSize());
  recipent->SetNextPageId(GetNextPageId());
  SetSize(0);
}
INDEX_TEMPLATE_ARGUMENTS
