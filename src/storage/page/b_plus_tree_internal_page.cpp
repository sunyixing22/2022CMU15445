 ...
 * @LastEditTime: 2023-07-16 17:06:14
 * @FilePath: /bustub-20221128-2022fall/src/storage/page/b_plus_tree_internal_page.cpp
...
/**
 * @description:find the first element >= key
 * @param {KeyType} &key
 * @param {KeyComparator} &cmp
 * @return {int}
 */
INDEX_TEMPLATE_ARGUMENTS
...
INDEX_TEMPLATE_ARGUMENTS
void B_PLUS_TREE_INTERNAL_PAGE_TYPE::CopyNFrom(MappingType *item, int size, BufferPoolManager *buffer_pool_manager) {
...
void B_PLUS_TREE_INTERNAL_PAGE_TYPE::MoveFirstToEndOf(
    BPlusTreeInternalPage<KeyType, ValueType, KeyComparator> *recipient, const KeyType &middle_key,
    BufferPoolManager *buffer_pool_manager) {
  SetKeyAt(0, middle_key);
